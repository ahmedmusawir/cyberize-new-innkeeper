  ...
  ?>
    ...
    <div class="container">
      ...
      <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 left-col" style="background: url(<?php echo $featured_img_url; ?>) no-repeat; background-size: cover;">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12 right-col">
